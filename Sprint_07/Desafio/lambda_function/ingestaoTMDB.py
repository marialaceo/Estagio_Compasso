...
# Definir variáveis de ambiente para o S3
...
def save_to_s3(movies, part_num):
    ...
    # Divide data into chunks of 100 items each
...
def process_romance_movies(tmdb, s3_client, bucket_name, genre_id):
    ...
    max_pages = min(total_pages, 2550)  # Garantir que não exceda o número total de páginas disponível
